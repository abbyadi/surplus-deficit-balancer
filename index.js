...
function createObjFnx(fnx) {
    return __awaiter(this, void 0, void 0, function* () {
        yield Excel.run((context) => __awaiter(this, void 0, void 0, function* () {
            ...
            const obj = Object.fromEntries(Object.entries(rangeNames).map(([key, name]) => [
                key,
            ...
            yield context.sync();
            yield fnx(obj, context);
        }));
    });
}
function balanceUses(obj, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
...
function balanceSources(obj, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < obj.rngSoftDebt.values.length; i++) {
            if (regExSoftDebt.test(obj.rngSoftDebt.values[i][0])) {
                newRange = sheetAssumptions.getRangeByIndexes(obj.rngSoftDebt.rowIndex + i + 1, obj.rngSoftDebt.columnIndex, 1, 1);
                break;
            }
        }
        if (!newRange) {
...
function maxFedCredits(obj, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
...
function fedCreditAdjstr(obj, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        const stateCreditProceeds = obj.currStateCreditAmt.values[0][0] * obj.statePricing.values[0][0] * obj.lpProfitLoss.values[0][0];
...
function stateCredAdjstr(obj, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        const currStateEquity = obj.currStateCreditAmt.values[0][0] * obj.lpProfitLoss.values[0][0] * obj.statePricing.values[0][0];
        const stateEquityNeeded = currStateEquity + -1 * obj.surplusShortfall.values[0][0];
        const stateCreditAmtNeed = stateEquityNeeded /
...
function deferFee(obj, ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingFeeFormula = obj.cashFeeLimit.formulas[0][0];
...
function tryCatch(callback, callbackParameter) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield callback(callbackParameter);
        }
        catch (error) {
            console.error(error);
        }
